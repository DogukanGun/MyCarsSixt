...
import com.dag.mycarssixt.base.ui.MyCarsSixtDialogBox
...
class ModelDialogHandler @Inject constructor(){
    ...
    fun createDialog(activity:FragmentActivity,dialog: ModelDialog):AppCompatDialog?{
        val alertDialog = MyCarsSixtDialogBox.showAlertDialog(
            activity = activity,
            ...
            buttonClickListener = object : MyCarsSixtDialogBox.ButtonClickListener(){
